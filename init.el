...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons swiper lsp-treemacs ls-treemacs lsp-ivy lsp-ui lsp-mode flycheck centaur-tabs expand-region treemacs-all-the-icons treemacs-projectile treemacs counsel ivy dashboard projectile doom-modeline doom-themes alchemist which-key use-package)))
(custom-set-faces
